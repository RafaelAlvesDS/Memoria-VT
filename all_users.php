...
$users = $C_BD->GetAll('select * from uol_users order by PostsUOL desc');
//print_r($users);
?>
<!doctype html>
<html lang="en">
    ...
    <body>
        ...
        <div class="album py-5 bg-light">
            <div class="container">
                    ...
                    <div class="row">
                        <?php for ($i = 0; $i < count($users); $i++) { if($users[$i]['Avatar']=='no avatar'){ continue; } $epoch = ($users[$i]['Cadastro']/1000)+2592000; $dt = new DateTime(); $dt->setTimestamp($epoch); ?>
                        <div class="col-md-2">
